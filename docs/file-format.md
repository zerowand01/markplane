...
│   ├── EPIC-001.md
│   ├── EPIC-002.md
│   └── archive/             # Completed/paused epics
├── backlog/
...
Also: `paused` (can resume to `active`)
...
- `epic.md` — New epics (objective, key results, backlog items table, progress, notes)
...
- **backlog/INDEX.md**: Items grouped by status, priority distribution, items by epic
- **roadmap/INDEX.md**: Epics grouped by status (active, planned, paused, done) with progress percentages
