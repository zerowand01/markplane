...
| `markplane_check` | Validate all cross-references in the project. Reports broken links, invalid statuses, asymmetric reciprocal links, and dependency cycles. | *(none)* | *(none)* |
