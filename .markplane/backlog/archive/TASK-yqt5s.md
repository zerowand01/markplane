...
One-line addition to the `serverInfo` JSON in `handle_initialize()`. Should be done alongside TASK-eduur and TASK-4c2mh since they all touch the same function.
