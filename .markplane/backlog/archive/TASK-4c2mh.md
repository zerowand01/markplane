...
This is a one-line change in `handle_initialize()` in `crates/markplane-mcp/src/main.rs`. Should be done alongside TASK-eduur and TASK-yqt5s since they all modify the same function.
